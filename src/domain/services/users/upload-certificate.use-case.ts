import { UploadCertificateUseCasePort } from '../../ports/inbound/users/upload-certificate.use-case.port';
...
export class UploadCertificateUseCase implements UploadCertificateUseCasePort {
  constructor(
  ...
  async execute(
    ...
    if (user) {
      const updatedUser = new UserEntity(
        ...
        user.linkedIn,
        user.cvUrl,
        [...user.certificates, certificateUrl],
      );
    ...
    if (teacher) {
      const updatedTeacher = new TeacherEntity(
        ...
        teacher.linkedIn,
        teacher.cvUrl,
        [...teacher.certificates, certificateUrl],
      );
    ...
    if (student) {
      const updatedStudent = new StudentEntity(
        ...
        student.linkedIn,
        student.cvUrl,
        [...student.certificates, certificateUrl],
      );
